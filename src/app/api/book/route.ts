    ...
    if (resend && NOTIFY_EMAILS) {
      ...
      if (emails.length > 0) {
        await resend.emails.send({
          from: "Gunes Bookings <onboarding@resend.dev>",
          to: emails,
          subject: `New Booking: ${customerName} — ${branch} (${date} ${time})`,
          html: `
            <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; background: #0a1a0a; color: #faf8f5; border-radius: 12px;">
              <h2 style="color: #d4af37; margin: 0 0 16px;">New Online Booking</h2>
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr><td style="padding: 8px 0; color: #7a9e7a;">Phone</td><td style="padding: 8px 0; color: #faf8f5;"><a href="tel:${customerPhone}" style="color: #d4af37;">${customerPhone}</a></td></tr>
