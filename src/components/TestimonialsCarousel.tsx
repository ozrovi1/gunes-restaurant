    ...
    <div className="w-full min-w-0 overflow-hidden">
      ...
      >
        {testimonials.map((t, i) => (
          ...
          >
            <div className="bg-[#0d1f0d]/80 backdrop-blur-sm p-8 sm:p-12 lg:p-16 flex flex-col justify-center relative rounded-2xl border border-[#d4af37]/10">
              <div className="absolute top-4 left-4 w-16 h-16 border-l-2 border-t-2 border-[#d4af37]/30 rounded-tl-lg" />
              <div className="absolute bottom-4 left-4 w-16 h-16 border-l-2 border-b-2 border-[#d4af37]/30 rounded-bl-lg" />
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                <span className="text-[#d4af37] text-sm">◆</span>
                <p className="text-[#d4af37] text-[11px] tracking-[0.3em] uppercase">Reviews</p>
                <span className="text-[#d4af37] text-sm">◆</span>
              </div>
              ...
              <p className="text-[#d4af37] text-[11px] tracking-[0.2em] uppercase mt-4 text-center lg:text-left">
                {t.author}
              </p>
            </div>
          </div>
        ...
        >
          {testimonials.map((_, i) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cta-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a1a0a] ${
                i === activeIndex
                  ? "bg-[#d4af37] w-6"
