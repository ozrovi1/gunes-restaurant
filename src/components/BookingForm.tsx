...
export function BookingForm({ branchSlug, branchName, onBack }: BookingFormProps) {
  ...
  // Generate time slots from 12:00 to 22:30 in 30-min increments
    ...
    return (
      <div className="text-center py-12 px-6">
        ...
        <p className="text-[#faf8f5]/60 text-sm mb-1">
          Thank you, {form.customerName}. Your reservation at <span className="text-[#d4af37]">{branchName}</span> is pending confirmation.
        </p>
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <h2 className="text-lg font-medium text-[#faf8f5] mb-1">
        Reserve at <span className="text-[#d4af37]">{branchName}</span>
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 bg-[#0d1f0d] border border-[#d4af37]/20 rounded text-[#faf8f5] text-sm focus:outline-none focus:border-[#d4af37]/50 transition-colors"
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <select
              ...
              className="booking-select w-full px-3 py-2.5 bg-[#0d1f0d] border border-[#d4af37]/20 rounded text-[#faf8f5] text-sm focus:outline-none focus:border-[#d4af37]/50 transition-colors"
              required
            >
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full py-3 bg-[#d4af37] text-[#0a1a0a] font-medium rounded hover:bg-[#e8c547] transition-colors disabled:opacity-50 text-sm"
        >
