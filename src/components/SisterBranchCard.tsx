...
export function SisterBranchCard({ branch, badge = "open" }: SisterBranchCardProps) {
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-2xl border border-[#d4a017]/25 bg-[#0d2818]/60 shadow-lg shadow-black/20 transition-all duration-300 hover:scale-[1.02] hover:border-[#d4a017]/50 hover:shadow-[0_0_24px_rgba(212,160,23,0.12)]">
