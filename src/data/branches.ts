export interface Branch {
  ...
  address: string;
  phone: string;
  /** Branch-specific contact email (optional — only some branches have one) */
  email?: string;
  hours: string;
  menuUrl?: string;
  ...
  /** Direct online-ordering app URL (Clover) — collection only. Shows the
   *  "Order Online" button when set. Mounted on the site via a rewrite. */
