export interface Branch {
  ...
  hours: string;
  menuUrl?: string;
  /** Shared full restaurant menu PDF (same across all Gunes branches) */
  fullMenuUrl?: string;
  mapEmbedUrl?: string;
  imageUrl?: string;
  /** Map center: [lat, lng] */
